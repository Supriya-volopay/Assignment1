...
export const fetchIncomeStatementAPI = createAsyncThunk("fetchCompanyOverviewAPI", async({param}, {dispatch}) => {
    try {
        if (isMockEnable) {
...
export const {setLoading, setAnnualReports, setQuarterlyReports, setError} = IncomeStatementSlice.actions;
